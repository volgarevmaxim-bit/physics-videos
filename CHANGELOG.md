...
- Служебная полоса над видео (utility bar): место под служебные элементы;
  пока там только гамбургер (смена профиля) — больше не перекрывает видео.

### Изменено

- Пул видео: три просмотренных (Кипение и конденсация, Охлаждение испарением,
  Шуховская башня) заменены на новые из отбора GetAClass — Электрические заряды,
  Самозапускающийся сифон, Наклонная плоскость (топ-3 ранжира этапа 3).
